...
class SliderController extends Controller
{
    ...
    public function saveslider(Request $request){
        ...
        $this->validate($request, ['description_one' => 'required' , 'description_two' => 'required', 'slider_image' => 'image|nullable|max:1999']);
    ...
    public function unactivate_slider($id){
        ...
        $slider->status = 0;
        $slider->update();
        return redirect('/sliders')->with('status', 'The Slider Status has been unactivate successfully');
    ...
    public function activate_slider($id){
        ...
        $slider->status = 1;
        $slider->update();
        return redirect('/sliders')->with('status', 'The Slider Status has been activate successfully');
