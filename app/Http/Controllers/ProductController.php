...
class ProductController extends Controller
{
    ...
    public function activate_product($id){
        ...
        $product->status = 1;
        $product->update();
        return redirect('/products')->with('status', 'The '.$product->product_name.' Product status has been activate successfully');
    ...
    public function unactivate_product($id){
        ...
        $product->status = 0;
        $product->update();
        return redirect('/products')->with('status', 'The '.$product->product_name.' Product status has been unactivate successfully');
